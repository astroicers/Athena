# ad-persistence — Athena MCP Tool Server
...
```bash
make new-tool NAME=ad-persistence
```
...
```bash
make dev-tool NAME=ad-persistence           # stdio mode
make dev-tool-http NAME=ad-persistence      # HTTP mode (port 8090)
```
