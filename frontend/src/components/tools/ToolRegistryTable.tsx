  ...
  return (
    <div>
      ...
      <div className="flex items-center h-9 px-3 bg-[var(--color-bg-surface)]">
        <div className="w-[260px] shrink-0 font-mono text-athena-floor font-bold uppercase tracking-[1px] text-[var(--color-text-secondary)]">
          {t("colName")}
        </div>
        <div className="w-[120px] shrink-0 font-mono text-athena-floor font-bold uppercase tracking-[1px] text-[var(--color-text-secondary)]">
          {t("colCategory")}
        </div>
        <div className="w-[70px] shrink-0 font-mono text-athena-floor font-bold uppercase tracking-[1px] text-[var(--color-text-secondary)]">
          {t("colStatus")}
        </div>
        <div className="w-[80px] shrink-0 font-mono text-athena-floor font-bold uppercase tracking-[1px] text-[var(--color-text-secondary)]">
          {t("colRisk")}
        </div>
        <div className="w-[180px] shrink-0 font-mono text-athena-floor font-bold uppercase tracking-[1px] text-[var(--color-text-secondary)]">
          {t("colMitre")}
        </div>
        <div className="w-[100px] shrink-0 font-mono text-athena-floor font-bold uppercase tracking-[1px] text-[var(--color-text-secondary)]">
          {t("colContainer")}
        </div>
        <div className="w-[80px] shrink-0 font-mono text-athena-floor font-bold uppercase tracking-[1px] text-[var(--color-text-secondary)] text-center">
          {t("colActions")}
        </div>
      </div>
          ...
          >
            ...
            <div className="flex flex-col w-[260px] shrink-0 gap-0.5">
              <div className="flex items-center gap-2">
                <span className="font-mono text-athena-floor font-semibold text-[var(--color-text-primary)] truncate">
                  {tool.name}
                </span>
                {tool.source === "user" && (
                  <button
                    ...
                    className="font-mono text-athena-floor font-semibold text-[var(--color-error)] bg-[#B91C1C14] border border-[#B91C1C40] rounded-[var(--radius)] px-1.5 py-0.5 shrink-0 cursor-pointer hover:bg-[#B91C1C20] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              {tool.description && (
                <span className="font-mono text-athena-floor font-normal text-[var(--color-text-secondary)] truncate max-w-[240px]">
                  {tool.description}
                </span>
              )}
            </div>
            ...
            <div className="w-[120px] shrink-0">
              <span
                className="font-mono text-athena-caption inline-block rounded-[var(--radius)] px-1.5 py-0.5"
                style={{
            ...
            >
              ...
              />
              <span
                className={`font-mono text-athena-floor font-semibold ${
            ...
            <div className="flex items-center w-[100px] shrink-0 gap-1.5">
              {status === "online" && (
                <>
                  ...
                  <span className="font-mono text-athena-floor text-[var(--color-success)]">
                    {t("containerOnline")}
                  </span>
                </>
              )}
              {status === "offline" && (
                <>
                  ...
                  <span className="font-mono text-athena-floor text-[var(--color-error)]">
                    {t("containerOffline")}
                  </span>
                </>
              )}
