...
1. **Red Team Aesthetic** — 深色底（#0a0a1a）、CRT 掃描線、六角形元素、多層光暈、戰術網格
2. **漸進式揭露** — Level 1 總覽（5 秒掌握）→ Level 2 列表（30 秒定位）→ Level 3 詳情（完整操作）
3. **設計即規格** — 所有視覺決策可量化、可追溯：設計決策 → Design Token → CSS 屬性
4. **投影機可讀** — 最小字級 12px、高對比文字（secondary: #c0c0d0）、大指標數字 32px
...
| 設計稿 | 涵蓋範圍 | 最後更新 |
|--------|---------|---------|
| athena-design-system.pen | 主設計系統（56 元件） | 2026-03-04 |
