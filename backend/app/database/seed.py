...
TOOL_REGISTRY_SEEDS = [
    ...
    {
        "tool_id": "lateral_mover",
        "name": "Lateral Movement Suite",
        "kind": "tool",
        "category": "credential_access",
    ...
    # --- AD Attack Chain Tools ---
    {
        "tool_id": "bloodhound_collector",
        "name": "BloodHound Collector",
        "kind": "tool",
        "category": "discovery",
        "description": "AD environment graph collection + attack path analysis via BloodHound",
        "mitre_techniques": '["T1087.002","T1069.002","T1482"]',
        "risk_level": "high",
        "output_traits": '["ad.bloodhound_data","ad.domain_users_count","ad.attack_path","ad.high_value_target","ad.domain_trust","ad.trust_direction"]',
        "config_json": '{"mcp_server":"bloodhound-collector","mcp_tool":"bloodhound_collect"}',
    },
    {
        "tool_id": "netexec_suite",
        "name": "NetExec Suite",
        "kind": "tool",
        "category": "credential_access",
        "description": "Multi-protocol AD enumeration, password spraying, remote execution via NetExec",
        "mitre_techniques": '["T1110.003","T1087.002","T1069.002","T1021.002","T1003.006"]',
        "risk_level": "critical",
        "output_traits": '["ad.smb_host","ad.smb_share","ad.smb_user","ad.gpp_password","credential.valid_pair","ad.sprayed_account","ad.asreproast_user","ad.kerberoastable_user","ad.laps_password","lateral.session","credential.shell","ad.spn_account"]',
        "config_json": '{"mcp_server":"netexec-suite","mcp_tool":"netexec_smb_enum"}',
    },
    {
        "tool_id": "certipy_ad",
        "name": "Certipy AD CS",
        "kind": "tool",
        "category": "credential_access",
        "description": "AD Certificate Services vulnerability exploitation (ESC1-ESC8)",
        "mitre_techniques": '["T1649","T1558.004","T1550.003"]',
        "risk_level": "critical",
        "output_traits": '["ad.vulnerable_template","ad.esc_type","ad.ca_name","ad.certificate_pfx","ad.impersonated_user","credential.hash","credential.certificate_auth","credential.shadow_credential"]',
        "config_json": '{"mcp_server":"certipy-ad","mcp_tool":"certipy_find"}',
    },
    {
        "tool_id": "responder_capture",
        "name": "Responder Capture",
        "kind": "tool",
        "category": "credential_access",
        "description": "LLMNR/NBT-NS/mDNS poisoning + NTLMv2 hash capture via Responder",
        "mitre_techniques": '["T1557.001","T1040"]',
        "risk_level": "critical",
        "output_traits": '["credential.ntlmv2_hash","ad.responder_victim","ad.responder_session","ad.responder_stopped"]',
        "config_json": '{"mcp_server":"responder-capture","mcp_tool":"responder_start"}',
    },
    # --- Cloud Attack Chain Tools ---
    {
        "tool_id": "cloudfox_enum",
        "name": "CloudFox Enumerator",
        "kind": "tool",
        "category": "discovery",
        "description": "AWS/Azure/GCP environment enumeration + privilege escalation path detection",
        "mitre_techniques": '["T1580","T1087.004","T1069.003"]',
        "risk_level": "high",
        "output_traits": '["cloud.iam_role","cloud.privesc_path","cloud.overprivileged_user","cloud.public_resource","cloud.secret_found","cloud.misconfiguration","cloud.env_variable","cloud.ssm_parameter"]',
        "config_json": '{"mcp_server":"cloudfox-enum","mcp_tool":"cloudfox_iam_enum"}',
    },
    {
        "tool_id": "pacu_aws",
        "name": "Pacu AWS",
        "kind": "tool",
        "category": "credential_access",
        "description": "AWS exploitation framework: IAM privesc, S3 enum, Lambda backdoor, EC2 enum",
        "mitre_techniques": '["T1078.004","T1530","T1525"]',
        "risk_level": "critical",
        "output_traits": '["cloud.iam_privesc","cloud.exploitable_policy","cloud.s3_bucket","cloud.s3_public_bucket","cloud.s3_sensitive_file","cloud.lambda_function","cloud.lambda_backdoor_opportunity","cloud.ec2_instance","cloud.security_group_open","cloud.ec2_public_ip"]',
        "config_json": '{"mcp_server":"pacu-aws","mcp_tool":"pacu_iam_privesc_scan"}',
    },
    {
        "tool_id": "scoutsuite_audit",
        "name": "ScoutSuite Auditor",
        "kind": "tool",
        "category": "discovery",
        "description": "Multi-cloud security compliance audit (AWS/Azure/GCP/Alibaba/Oracle)",
        "mitre_techniques": '["T1580","T1526"]',
        "risk_level": "medium",
        "output_traits": '["cloud.audit_finding","cloud.critical_count","cloud.high_count","cloud.service_finding","cloud.misconfiguration"]',
        "config_json": '{"mcp_server":"scoutsuite-audit","mcp_tool":"scoutsuite_audit"}',
    },
    # --- AD Advanced Attack Tools ---
    {
        "tool_id": "impacket_ad",
        "name": "Impacket AD Kerberos",
        "kind": "tool",
        "category": "credential_access",
        "description": "Kerberos ticket attacks: Golden/Silver Ticket forgery, Over-Pass-the-Hash, S4U delegation abuse, SID lookup",
        "mitre_techniques": '["T1558.001","T1558.002","T1550.003"]',
        "risk_level": "critical",
        "output_traits": '["credential.golden_ticket","credential.silver_ticket","credential.tgt","credential.service_ticket","ad.delegation_abuse","ad.domain_sid","ad.domain_account"]',
        "config_json": '{"mcp_server":"impacket-ad","mcp_tool":"impacket_golden_ticket"}',
    },
    {
        "tool_id": "ad_exploiter",
        "name": "AD ACL/GPO Exploiter",
        "kind": "tool",
        "category": "privilege_escalation",
        "description": "AD ACL/GPO/Delegation exploitation: WriteDACL, GenericAll, RBCD, GPO modification, SID-History injection, AdminSDHolder",
        "mitre_techniques": '["T1222.001","T1484.001","T1134.005"]',
        "risk_level": "critical",
        "output_traits": '["ad.acl_modified","ad.rbcd_configured","ad.gpo_modified","ad.sid_history_injected","ad.adminsdholder_modified"]',
        "config_json": '{"mcp_server":"ad-exploiter","mcp_tool":"ad_acl_abuse"}',
    },
    {
        "tool_id": "coercion_tools",
        "name": "Authentication Coercion",
        "kind": "tool",
        "category": "credential_access",
        "description": "Authentication coercion attacks: PetitPotam (MS-EFSR), PrinterBug (MS-RPRN), DFSCoerce (MS-DFSNM)",
        "mitre_techniques": '["T1187","T1557.001"]',
        "risk_level": "high",
        "output_traits": '["ad.coercion_result","ad.coerced_auth","ad.coercion_method"]',
        "config_json": '{"mcp_server":"coercion-tools","mcp_tool":"coerce_petitpotam"}',
    },
    {
        "tool_id": "ad_persistence",
        "name": "AD Persistence Suite",
        "kind": "tool",
        "category": "persistence",
        "description": "AD persistence techniques: Skeleton Key, DNSAdmins DLL abuse, DSRM backdoor, custom SSP registration",
        "mitre_techniques": '["T1556.001","T1547.005","T1098"]',
        "risk_level": "critical",
        "output_traits": '["ad.skeleton_key","ad.dnsadmins_dll","ad.dsrm_enabled","ad.custom_ssp"]',
        "config_json": '{"mcp_server":"ad-persistence","mcp_tool":"persist_skeleton_key"}',
    },
    {
        "tool_id": "ntlm_relay",
        "name": "NTLM Relay Suite",
        "kind": "tool",
        "category": "credential_access",
        "description": "NTLM relay attacks: relay to LDAP (RBCD delegation), relay to SMB (command exec), with listener lifecycle",
        "mitre_techniques": '["T1557.001","T1550.002"]',
        "risk_level": "critical",
        "output_traits": '["ad.relay_session","ad.relay_result","ad.relay_delegated","credential.shell","ad.relay_stopped"]',
        "config_json": '{"mcp_server":"ntlm-relay","mcp_tool":"ntlm_relay_to_ldap"}',
    },
    {
        "tool_id": "hashcat_crack",
        "name": "Hashcat Cracker",
        "kind": "tool",
        "category": "credential_access",
        "description": "Hash cracking with Hashcat: AS-REP Roasting, Kerberoasting, NTLM hash cracking, session status",
        "mitre_techniques": '["T1110.002"]',
        "risk_level": "high",
        "output_traits": '["credential.cracked_password","credential.crack_progress"]',
        "config_json": '{"mcp_server":"hashcat-crack","mcp_tool":"hashcat_crack_asrep"}',
    },
]
...
TECHNIQUE_SEEDS = [
    ...
    {
        "mitre_id": "T1222.001",
        "name": "File and Directory Permissions Modification: Windows DACL",
        "tactic": "Defense Evasion",
        "tactic_id": "TA0005",
        "risk_level": "high",
        "platforms": '["windows"]',
...
MCP_DISCOVERED_MITRE: dict[str, dict[str, str]] = {
    ...
    "credential-checker_winrm_credential_check": {
        "category": "credential_access",
        "mitre": '["T1110.001","T1021.006"]',
    },
    ...
    "bloodhound-collector_bloodhound_collect": {"category": "discovery", "mitre": '["T1087.002","T1069.002","T1482"]'},
    "bloodhound-collector_bloodhound_find_paths": {"category": "discovery", "mitre": '["T1087.002","T1069.002"]'},
    "bloodhound-collector_bloodhound_enum_trusts": {"category": "discovery", "mitre": '["T1482"]'},
    # --- NetExec Suite ---
    "netexec-suite_netexec_smb_enum": {"category": "discovery", "mitre": '["T1087.002","T1069.002","T1021.002"]'},
    "netexec-suite_netexec_password_spray": {"category": "credential_access", "mitre": '["T1110.003"]'},
    "netexec-suite_netexec_ldap_enum": {
        "category": "credential_access",
        "mitre": '["T1087.002","T1558.003","T1003.006"]',
    },
    "netexec-suite_netexec_exec": {"category": "execution", "mitre": '["T1021.002","T1047"]'},
    "netexec-suite_netexec_spn_enum": {"category": "discovery", "mitre": '["T1087.002","T1558.003"]'},
    # --- Certipy AD CS ---
    "certipy-ad_certipy_find": {"category": "discovery", "mitre": '["T1649"]'},
    "certipy-ad_certipy_request": {"category": "credential_access", "mitre": '["T1649","T1550.003"]'},
    "certipy-ad_certipy_auth": {"category": "credential_access", "mitre": '["T1649","T1558.004"]'},
    "certipy-ad_certipy_shadow": {"category": "credential_access", "mitre": '["T1649","T1550.003"]'},
    # --- Responder Capture ---
    "responder-capture_responder_start": {"category": "credential_access", "mitre": '["T1557.001","T1040"]'},
    "responder-capture_responder_collect": {"category": "credential_access", "mitre": '["T1557.001","T1040"]'},
    "responder-capture_responder_stop": {"category": "credential_access", "mitre": '["T1557.001"]'},
    # --- CloudFox Enumerator ---
    "cloudfox-enum_cloudfox_iam_enum": {"category": "discovery", "mitre": '["T1087.004","T1069.003","T1580"]'},
    "cloudfox-enum_cloudfox_all_checks": {"category": "discovery", "mitre": '["T1580"]'},
    "cloudfox-enum_cloudfox_find_secrets": {"category": "credential_access", "mitre": '["T1580","T1552.005"]'},
    # --- Pacu AWS ---
    "pacu-aws_pacu_iam_privesc_scan": {"category": "credential_access", "mitre": '["T1078.004","T1087.004"]'},
    "pacu-aws_pacu_s3_enum": {"category": "collection", "mitre": '["T1530"]'},
    "pacu-aws_pacu_lambda_backdoor": {"category": "credential_access", "mitre": '["T1525"]'},
    "pacu-aws_pacu_ec2_enum": {"category": "discovery", "mitre": '["T1580","T1087.004"]'},
    # --- ScoutSuite Auditor ---
    "scoutsuite-audit_scoutsuite_audit": {"category": "discovery", "mitre": '["T1580","T1526"]'},
    "scoutsuite-audit_scoutsuite_service_check": {"category": "discovery", "mitre": '["T1580","T1526"]'},
    # --- Impacket AD Kerberos ---
    "impacket-ad_impacket_golden_ticket": {"category": "credential_access", "mitre": '["T1558.001"]'},
    "impacket-ad_impacket_silver_ticket": {"category": "credential_access", "mitre": '["T1558.002"]'},
    "impacket-ad_impacket_get_tgt": {"category": "credential_access", "mitre": '["T1550.003","T1558.001"]'},
    "impacket-ad_impacket_get_st": {"category": "credential_access", "mitre": '["T1550.003","T1134.001"]'},
    "impacket-ad_impacket_lookup_sid": {"category": "discovery", "mitre": '["T1087.002"]'},
    # --- AD ACL/GPO Exploiter ---
    "ad-exploiter_ad_acl_abuse": {"category": "privilege_escalation", "mitre": '["T1222.001","T1003.006"]'},
    "ad-exploiter_ad_rbcd_attack": {"category": "privilege_escalation", "mitre": '["T1134.001","T1550.003"]'},
    "ad-exploiter_ad_gpo_abuse": {"category": "privilege_escalation", "mitre": '["T1484.001"]'},
    "ad-exploiter_ad_sid_history": {"category": "privilege_escalation", "mitre": '["T1134.005"]'},
    "ad-exploiter_ad_adminsdholder": {"category": "persistence", "mitre": '["T1098","T1222.001"]'},
    # --- Authentication Coercion ---
    "coercion-tools_coerce_petitpotam": {"category": "credential_access", "mitre": '["T1187","T1557.001"]'},
    "coercion-tools_coerce_printerbug": {"category": "credential_access", "mitre": '["T1187","T1557.001"]'},
    "coercion-tools_coerce_dfscoerce": {"category": "credential_access", "mitre": '["T1187","T1557.001"]'},
    "coercion-tools_coerce_scan": {"category": "discovery", "mitre": '["T1187"]'},
    # --- AD Persistence ---
    "ad-persistence_persist_skeleton_key": {"category": "persistence", "mitre": '["T1556.001"]'},
    "ad-persistence_persist_dnsadmins": {"category": "persistence", "mitre": '["T1098","T1543.003"]'},
    "ad-persistence_persist_dsrm": {"category": "persistence", "mitre": '["T1556.001"]'},
    "ad-persistence_persist_custom_ssp": {"category": "persistence", "mitre": '["T1547.005"]'},
    # --- NTLM Relay ---
    "ntlm-relay_ntlm_relay_to_ldap": {"category": "credential_access", "mitre": '["T1557.001","T1550.002"]'},
    "ntlm-relay_ntlm_relay_to_smb": {"category": "credential_access", "mitre": '["T1557.001","T1550.002"]'},
    "ntlm-relay_ntlm_relay_collect": {"category": "credential_access", "mitre": '["T1557.001"]'},
    "ntlm-relay_ntlm_relay_stop": {"category": "credential_access", "mitre": '["T1557.001"]'},
    # --- Hashcat Cracker ---
    "hashcat-crack_hashcat_crack_asrep": {"category": "credential_access", "mitre": '["T1110.002","T1558.004"]'},
    "hashcat-crack_hashcat_crack_kerberoast": {"category": "credential_access", "mitre": '["T1110.002","T1558.003"]'},
    "hashcat-crack_hashcat_crack_ntlm": {"category": "credential_access", "mitre": '["T1110.002"]'},
    "hashcat-crack_hashcat_status": {"category": "credential_access", "mitre": '["T1110.002"]'},
}
