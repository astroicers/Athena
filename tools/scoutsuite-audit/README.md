# scoutsuite-audit — Athena MCP Tool Server
...
```bash
make new-tool NAME=scoutsuite-audit
```
...
```bash
make dev-tool NAME=scoutsuite-audit           # stdio mode
make dev-tool-http NAME=scoutsuite-audit      # HTTP mode (port 8090)
```
