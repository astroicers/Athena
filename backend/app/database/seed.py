...
TOOL_REGISTRY_SEEDS = [
    ...
    {"tool_id": "bloodhound_collector", "name": "BloodHound Collector", "kind": "tool",
     "category": "discovery",
    ...
    {"tool_id": "netexec_suite", "name": "NetExec Suite", "kind": "tool",
     "category": "credential_access",
    ...
    {"tool_id": "certipy_ad", "name": "Certipy AD CS", "kind": "tool",
     "category": "credential_access",
    ...
    {"tool_id": "responder_capture", "name": "Responder Capture", "kind": "tool",
     "category": "credential_access",
    ...
    {"tool_id": "cloudfox_enum", "name": "CloudFox Enumerator", "kind": "tool",
     "category": "discovery",
    ...
    {"tool_id": "pacu_aws", "name": "Pacu AWS", "kind": "tool",
     "category": "credential_access",
    ...
    {"tool_id": "scoutsuite_audit", "name": "ScoutSuite Auditor", "kind": "tool",
     "category": "discovery",
...
TECHNIQUE_SEEDS = [
    ...
    {"mitre_id": "T1087.002", "name": "Account Discovery: Domain Account",
     "tactic": "Discovery", "tactic_id": "TA0007", "risk_level": "low", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1482", "name": "Domain Trust Discovery",
     "tactic": "Discovery", "tactic_id": "TA0007", "risk_level": "low", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1110.003", "name": "Brute Force: Password Spraying",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "medium", "platforms": '["windows","linux"]',
     "noise_level": "high"},
    {"mitre_id": "T1557.001", "name": "LLMNR/NBT-NS Poisoning and SMB Relay",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "high", "platforms": '["windows"]',
     "noise_level": "medium"},
    {"mitre_id": "T1649", "name": "Steal or Forge Authentication Certificates",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "high", "platforms": '["windows"]',
     "noise_level": "medium"},
    # --- Cloud Attack Chain Techniques ---
    {"mitre_id": "T1087.004", "name": "Account Discovery: Cloud Account",
     "tactic": "Discovery", "tactic_id": "TA0007", "risk_level": "low", "platforms": '["cloud"]',
     "noise_level": "low"},
    {"mitre_id": "T1069.003", "name": "Permission Groups Discovery: Cloud Groups",
     "tactic": "Discovery", "tactic_id": "TA0007", "risk_level": "low", "platforms": '["cloud"]',
     "noise_level": "low"},
    {"mitre_id": "T1530", "name": "Data from Cloud Storage",
     "tactic": "Collection", "tactic_id": "TA0009", "risk_level": "medium", "platforms": '["cloud"]',
     "noise_level": "low"},
    {"mitre_id": "T1580", "name": "Cloud Infrastructure Discovery",
     "tactic": "Discovery", "tactic_id": "TA0007", "risk_level": "low", "platforms": '["cloud"]',
     "noise_level": "low"},
]
...
MCP_DISCOVERED_MITRE: dict[str, dict[str, str]] = {
    ...
    "netexec-suite_netexec_ldap_enum":              {"category": "credential_access",    "mitre": '["T1087.002","T1558.003","T1003.006"]'},
