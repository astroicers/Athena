        ...
        <>
          ...
          {domains.map((domain) => (
            <button
              ...
              className="px-1.5 py-0.5 bg-white/20 hover:bg-white/30 rounded-athena-sm text-[10px] uppercase font-bold tracking-wider transition-colors disabled:opacity-50"
            >
