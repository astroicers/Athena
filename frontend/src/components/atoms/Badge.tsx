...
export function Badge({ variant = "info", children }: BadgeProps) {
  return (
    <span
      className={`inline-flex items-center shrink-0 whitespace-nowrap px-[var(--sp-badge-x)] py-[var(--sp-badge-y)] rounded-full text-athena-caption font-mono font-semibold border
