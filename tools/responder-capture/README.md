# responder-capture — Athena MCP Tool Server
...
```bash
make new-tool NAME=responder-capture
```
...
```bash
make dev-tool NAME=responder-capture           # stdio mode
make dev-tool-http NAME=responder-capture      # HTTP mode (port 8090)
```
