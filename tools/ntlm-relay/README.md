# ntlm-relay — Athena MCP Tool Server
...
```bash
make dev-tool NAME=ntlm-relay           # stdio mode
make dev-tool-http NAME=ntlm-relay      # HTTP mode (port 8090)
```
