...
TOOL_REGISTRY_SEEDS = [
    ...
    {"tool_id": "impacket_ad", "name": "Impacket AD Kerberos", "kind": "tool",
     "category": "credential_access",
    ...
    {"tool_id": "ad_exploiter", "name": "AD ACL/GPO Exploiter", "kind": "tool",
    ...
    {"tool_id": "coercion_tools", "name": "Authentication Coercion", "kind": "tool",
     "category": "credential_access",
    ...
    {"tool_id": "ad_persistence", "name": "AD Persistence Suite", "kind": "tool",
    ...
    {"tool_id": "ntlm_relay", "name": "NTLM Relay Suite", "kind": "tool",
     "category": "credential_access",
    ...
    {"tool_id": "hashcat_crack", "name": "Hashcat Cracker", "kind": "tool",
     "category": "credential_access",
...
TECHNIQUE_SEEDS = [
    ...
    {"mitre_id": "T1558.001", "name": "Steal or Forge Kerberos Tickets: Golden Ticket",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "critical", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1558.002", "name": "Steal or Forge Kerberos Tickets: Silver Ticket",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "high", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1550.003", "name": "Use Alternate Authentication Material: Pass the Ticket",
     "tactic": "Defense Evasion", "tactic_id": "TA0005", "risk_level": "high", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1222.001", "name": "File and Directory Permissions Modification: Windows DACL",
     "tactic": "Defense Evasion", "tactic_id": "TA0005", "risk_level": "high", "platforms": '["windows"]',
     "noise_level": "medium"},
    {"mitre_id": "T1484.001", "name": "Domain Policy Modification: Group Policy Modification",
     "tactic": "Defense Evasion", "tactic_id": "TA0005", "risk_level": "critical", "platforms": '["windows"]',
     "noise_level": "medium"},
    {"mitre_id": "T1134.005", "name": "Access Token Manipulation: SID-History Injection",
     "tactic": "Defense Evasion", "tactic_id": "TA0005", "risk_level": "critical", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1187", "name": "Forced Authentication",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "high", "platforms": '["windows"]',
     "noise_level": "medium"},
    {"mitre_id": "T1556.001", "name": "Modify Authentication Process: Domain Controller Authentication",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "critical", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1547.005", "name": "Boot or Logon Autostart Execution: Security Support Provider",
     "tactic": "Persistence", "tactic_id": "TA0003", "risk_level": "critical", "platforms": '["windows"]',
     "noise_level": "low"},
    {"mitre_id": "T1110.002", "name": "Brute Force: Password Cracking",
     "tactic": "Credential Access", "tactic_id": "TA0006", "risk_level": "medium", "platforms": '["windows","linux"]',
     "noise_level": "low"},
    {"mitre_id": "T1098", "name": "Account Manipulation",
     "tactic": "Persistence", "tactic_id": "TA0003", "risk_level": "high", "platforms": '["windows","linux","cloud"]',
     "noise_level": "medium"},
    {"mitre_id": "T1550.002", "name": "Use Alternate Authentication Material: Pass the Hash",
     "tactic": "Defense Evasion", "tactic_id": "TA0005", "risk_level": "high", "platforms": '["windows"]',
     "noise_level": "low"},
]
