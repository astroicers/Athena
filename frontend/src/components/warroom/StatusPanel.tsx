...
function actionStyle(action: string): { bg: string; text: string } {
  switch (action.toUpperCase()) {
    case "GO":
      return { bg: "bg-athena-success/[0.12]", text: "text-athena-success" };
    case "CAUTION":
      return { bg: "bg-athena-warning/[0.12]", text: "text-athena-warning" };
    case "HOLD":
      return { bg: "bg-athena-accent/[0.12]", text: "text-athena-accent" };
    case "ABORT":
      return { bg: "bg-athena-error/[0.12]", text: "text-athena-error" };
    default:
      return { bg: "bg-athena-surface", text: "text-athena-text-secondary" };
  }
}
