# impacket-ad — Athena MCP Tool Server
...
```bash
make new-tool NAME=impacket-ad
```
...
```bash
make dev-tool NAME=impacket-ad           # stdio mode
make dev-tool-http NAME=impacket-ad      # HTTP mode (port 8090)
```
