# privesc-scanner — Athena MCP Tool Server
...
```bash
make new-tool NAME=privesc-scanner
```
...
```bash
make dev-tool NAME=privesc-scanner           # stdio mode
make dev-tool-http NAME=privesc-scanner      # HTTP mode (port 8090)
```
