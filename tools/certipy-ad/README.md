# certipy-ad — Athena MCP Tool Server
...
```bash
make dev-tool NAME=certipy-ad           # stdio mode
make dev-tool-http NAME=certipy-ad      # HTTP mode (port 8090)
```
