# hashcat-crack — Athena MCP Tool Server
...
```bash
make new-tool NAME=hashcat-crack
```
...
```bash
make dev-tool NAME=hashcat-crack           # stdio mode
make dev-tool-http NAME=hashcat-crack      # HTTP mode (port 8090)
```
