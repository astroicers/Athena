          ...
          return (
            <div key={d.id} className="flex flex-col gap-0.5">
              <div className="flex items-center gap-2">
                ...
                {/* Status text */}
                <span className="text-athena-floor text-athena-text-tertiary w-16 shrink-0 truncate">
                  {d.status}
                </span>
              </div>
              ...
              {/* Hard limit tag */}
              {hardLimit && (
                <span className="text-athena-floor text-athena-error bg-athena-error/[0.08] border border-[var(--color-error)]/[0.25] rounded-[var(--radius)] px-2 py-1 ml-12 w-fit">
                  {hardLimit.rule}
                </span>
              )}
              ...
              {/* Warning tag */}
              {warning && !hardLimit && (
                <span className="text-athena-floor text-athena-warning bg-athena-warning/[0.08] border border-[var(--color-warning)]/[0.25] rounded-[var(--radius)] px-2 py-1 ml-12 w-fit">
                  {warning.message}
                </span>
              )}
            </div>
